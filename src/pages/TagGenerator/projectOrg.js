...
/* TODO: This belongs in it's on JSON file */
const allOrgNames ={
...
return(
  <div className={classes.autoCompleteText} style={{width: '100%', margin: '0 auto'}}>
  ...
  {renderSuggestions()}
  {showProjInfo ? <ProjectInfo style={{width: '100%', margin: '0 auto'}} /> : null}
