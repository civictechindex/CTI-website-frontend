                ...
                return (
                    <Grid item style={{ margin: 'auto' }} align='center' >
                        <Card className={classes.root} style={{ position: 'relative', padding: '0px', marginBottom: '5px', width: '1184px' }}>
                            <Paper elevation={0} style={styles.outerCardContainer}>
                                <Grid item>
                                    <Paper elevation={0} style={styles.innerCardContainer}>
                                ...
                                <Grid item style={{ border: '2px solid red' }}>
                                    ...
                                    <Card className={classes.root} >
                                        <CardMedia
                                            ...
                                            image="/images/dsktp-photo-of-people-standing-near-window-3184427.png"
