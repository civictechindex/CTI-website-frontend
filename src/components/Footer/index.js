...
const Footer = () => {
  ...
  const links = {
    about: [
      { key: 'about', text: 'Overview', to: '/about' },
    ],
    join: [
      { key: 'tag_gen', text: 'Tag Generator', to: '/tag-generator' },
    ],
    contribute: [
      { key: 'contrib_all', text: 'Index Contributors', to: '/contributors/all' },
      { key: 'contrib_unaff', text: 'Unaffiliated', to: '/contributors/unaffiliated' },
      { key: 'contrib_aff', text: 'Affiliated', to: '/contributors/affiliated' },
    ],
    collaborate: [
      { key: 'support', text: 'Collaborate with Us', to: '/support' },
      { key: 'add_proj', text: 'How to Do It', to: '/adding-projects-to-the-index' },
  ...
  return largeScreen ? <FooterLarge links={links} /> : <FooterSmall links={links} />;
};
